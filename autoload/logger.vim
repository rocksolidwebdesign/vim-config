...
function! s:configure_language_defaults()
	...
	call s:set_default('logger_sh_prefix', 'echo "')
	call s:set_default('logger_sh_suffix', '"')
	call s:set_default('logger_sh_token_prefix', ' ${')
	call s:set_default('logger_sh_token_suffix', '}')
	call s:set_default('logger_sh_quote_char', '')
	call s:set_default('logger_sh_arg_separator', '')
	call s:set_default('logger_sh_label_suffix', ':')
